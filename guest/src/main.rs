...
const MODEXP_BASE: [u8; 32] = [
    0x25, 0x17, 0xfe, 0x30, 0x84, 0x01, 0xb1, 0x21, 0x0b, 0x8d, 0xd1, 0xd6, 0xfe, 0xdc, 0x9f, 0x6f,
    0xc7, 0xf5, 0x5b, 0x92, 0xd4, 0x30, 0x8c, 0x42, 0xae, 0x72, 0xd8, 0xb8, 0x26, 0xb8, 0x58, 0xa1,
];
